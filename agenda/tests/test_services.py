...
def test_buscar_por_uuids_calls_correct_url_and_params(mock_http_client_post: Any) -> None:
    ...
    svc.buscar_por_uuids_ordenado_por_ranking_escolha(uuids=['aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'], fields='uuid,ranking_escolha')
    ...
    assert call_kw['params'] == {'fields': 'uuid,ranking_escolha', 'order_by': 'ranking_escolha'}
...
def test_buscar_por_uuids_custom_fields_and_timeout(mock_http_client_post: Any) -> None:
    ...
    svc.buscar_por_uuids_ordenado_por_ranking_escolha(uuids=['uuid-1'], fields='uuid,nome,ranking_escolha')
...
def test_buscar_por_uuids_converts_uuids_to_strings(mock_http_client_post: Any) -> None:
    ...
    u = uuid.uuid4()
    svc = CandidatosApiService(base_url='http://x.com')
    svc.buscar_por_uuids_ordenado_por_ranking_escolha(uuids=[u])  # type: ignore[list-item]
